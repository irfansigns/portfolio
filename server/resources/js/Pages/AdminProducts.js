                                        ...
                                        {props.pro.map(product=>{
                                          return(
                                              <tr id={product.id}>
                                                  ...
                                                  <td>{product.price}</td>
                                                  <td>
                                                    <button  className="btn-small btn-primary mr-1"><InertiaLink href={product.edit_url}>Edit</InertiaLink></button>
                                                  ...
                                                  <td><img className="w-25" src={base_url +'/img/' +product.ipath} alt="..." /></td>
                                              </tr>
                                          )
                                        })}
