            ...
            <nav className="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a className="navbar-brand" href="index.html"><span className="font-weight-bold text-uppercase text-dark">Replica Lounge</span></a>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul className="navbar-nav ml-auto">               
                  ...
                  {card.props.loginDetail.isLoggedIn ?<li className="nav-item"><InertiaLink className="nav-link" method="post" href={route('logout')}> <i className="fas fa-user-alt mr-1 text-gray"></i>Logout</InertiaLink></li>:
                  <li className="nav-item"><InertiaLink className="nav-link" method="get" href={route('login')}> <i className="fas fa-user-alt mr-1 text-gray"></i>Login</InertiaLink></li>
                  } 
