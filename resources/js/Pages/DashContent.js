                  ...
                  <div className="card bg-common card-left">
                    <nav className="nav flex-column">
                      ...
                      <a data-toggle="tab" className="nav-link" href="#notification">
                        <i className="fas fa-bell mr-2"></i>Notifications</a>
                      ...
                      <a data-toggle="tab" className="nav-link" href="#billing">
                        <i className="fas fa-money-check-alt mr-2"></i>Billing</a>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body tab-content border-0">
                      ...
                      <div className="tab-pane" id="notification">
                        ...
                        <form>
                          <div className="mb-3">
                            <label htmlFor="examplinput2" className="form-label">Security Alerts</label>
                            <small className="form-text text-muted">Receive Security alert notifications via Email</small><br />
                            <div className="form-check">
                              <input type="checkbox" className="form-check-input" id="examplpass" placeholder="Enter Your Old Password"></input>
                              <label htmlFor="examplinput2" className="form-check-label">Email each time a vulnerability is found</label>
                            </div>
                          </div>

                          <div className="mb-3">
                            <label className="d-block mb-3">SMS Notifications</label>
                            <ul className="list-group">
                              ...
                              <li className="list-group-item">Updates from People
                                <div className="form-check form-switch">
                                  <input className="form-check-input" type="checkbox" />
                                  <label className="form-check-label"></label>
                                </div>
                              ...
                              <li className="list-group-item">Reminders
                                <div className="form-check form-switch">
                                  <input className="form-check-input" type="checkbox" />
                                  <label className="form-check-label"></label>
                                </div>
                      ...
                      <div className="tab-pane" id="billing">
                        ...
                        <form>
                          <div className="mb-3">
                            ...
                            <small className="text-muted small">You have not added any payment method</small><br />
