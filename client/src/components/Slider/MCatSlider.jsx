    ...
    return (
        <>
          ...
          <div className="row">
            ...
            <div className="col-md-4 mb-4 mb-md-0"><a className="category-item" href="shop.html"><Cat1Slider code="1" /><strong className="category-item-title">Jewellery</strong></a></div>
            <div className="col-md-4 mb-4 mb-md-0"><a className="category-item mb-4" href="shop.html"><Cat1Slider code="2" /><strong className="category-item-title">Kids</strong></a><a className="category-item" href="shop.html"><Cat1Slider code="3" /><strong className="category-item-title">Fashion</strong></a></div>
